...
<head>
    ...
    <link href="{{ asset('metronic/assets/layouts/css/components-md.min.css') }}" rel="stylesheet" id="style_components" type="text/css" />
    ...
    <link href="{{ asset('metronic/assets/layouts/layout3/css/themes/default.min.css') }}" rel="stylesheet" type="text/css" id="style_color" />
        ...
        <div class="page-wrapper-middle">
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    <!-- BEGIN CONTENT BODY -->
                    <!-- BEGIN PAGE HEAD-->
                    @include('metronic.blades.page-head')
                    <!-- END PAGE HEAD-->
