...
<head>
    ...
    <link href="{!! asset('metronic/assets/global/plugins/fullcalendar/fullcalendar.min.css') !!}" rel="stylesheet"
          type="text/css"/>
    <link href="{!! asset('metronic/assets/global/plugins/jqvmap/jqvmap/jqvmap.css') !!}" rel="stylesheet"
          type="text/css"/>
    <!-- END PAGE LEVEL PLUGINS -->
    <!-- BEGIN THEME GLOBAL STYLES -->
    <link href="{{ asset('metronic/assets/layouts/css/components-md.min.css') }}" rel="stylesheet" id="style_components"
          type="text/css"/>
    <link href="{{ asset('metronic/assets/global/css/plugins-md.min.css') }}" rel="stylesheet" type="text/css"/>
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN THEME LAYOUT STYLES -->
    <link href="{{ asset('metronic/assets/layouts/layout3/css/layout.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/assets/layouts/layout3/css/themes/default.min.css') }}" rel="stylesheet"
          type="text/css" id="style_color"/>
    <link href="{{ asset('metronic/assets/layouts/layout3/css/custom.min.css') }}" rel="stylesheet" type="text/css"/>
...
<div class="page-wrapper">
    <div class="page-wrapper-row">
        <div class="page-wrapper-top">
            <!-- BEGIN HEADER -->
        @include('metronic.blades.header')
        <!-- END HEADER -->
        </div>
    </div>
    <div class="page-wrapper-row full-height">
        <div class="page-wrapper-middle">
            ...
            <div class="page-container">
                    ...
                    <div class="page-head">
                        <div class="container">
                            ...
                            <div class="page-title">
                                <h1>
                                    @yield('title') <small> @yield('title-description')</small>
                                </h1>
                            </div>
                            <!-- END PAGE TITLE -->
                            @include('metronic.blades.page-title')
                        </div>
                    </div>
                    <!-- END PAGE HEAD-->
                ...
                <!-- BEGIN QUICK SIDEBAR -->
            @include('metronic.blades.sidebar')
            <!-- END QUICK SIDEBAR -->
            </div>
            <!-- END CONTAINER -->
        </div>
    ...
    <div class="page-wrapper-row">
        <div class="page-wrapper-bottom">
            <!-- BEGIN FOOTER -->
        @include('metronic.blades.footer')
        <!-- END FOOTER -->
        </div>
    </div>
</div>
<!-- BEGIN QUICK NAV -->
@include('metronic.blades.quick-nav')
<!-- END QUICK NAV -->
<!--[if lt IE 9]>
...
<script src="{{ asset('metronic/assets/global/plugins/bootstrap/js/bootstrap.min.js') }}"
...
<script src="{{ asset('metronic/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js') }}"
        type="text/javascript"></script>
...
<script src="{{ asset('metronic/assets/layouts/layout3/scripts/layout.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('metronic/assets/layouts/layout3/scripts/demo.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('metronic/assets/layouts/global/scripts/quick-sidebar.min.js') }}"
        type="text/javascript"></script>
