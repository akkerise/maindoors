<header class="main-header">
  ...
  <!-- Logo -->
  <a href="{{ route('admin.dashboard.getDashboard') }}" class="logo">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                {{ Auth::user()->username }} - {{ Auth::user()->level !== 1 ? 'Fuck Permission On Here?' : 'Admin' }}
                <small>Member since {{ date_format(Auth::user()->created_at,'Y - m - d') }}</small>
              </p>
            </li>
            <!-- Menu Body -->
            <li class="user-body">
